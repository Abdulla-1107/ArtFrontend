              ...
              >
                <DialogHeader className="p-6 pb-4 bg-gradient-to-br from-primary/5 to-accent/5">
                  ...
                  <DialogDescription className="text-center text-base mt-2">
                    <span className="font-semibold text-foreground">{artworkTitle}</span>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-base">
                      {t('purchase.form.name')} <span className="text-destructive">*</span>
                    </Label>
                    <Input
                      id="name"
                      value={name}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phone" className="text-base">
                      {t('purchase.form.phone')} <span className="text-destructive">*</span>
                    </Label>
                    <Input
                      id="phone"
                      type="tel"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-base">
                      {t('purchase.form.email')} <span className="text-muted-foreground text-sm">({t('purchase.form.optional')})</span>
                    </Label>
                    <Input
                      id="email"
                      type="email"
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-2 mt-4 text-primary">
                    ...
                    <span className="text-sm font-medium">{t('purchase.success.thankYou')}</span>
                    <Sparkles className="w-5 h-5 animate-pulse" />
                  </div>
                </motion.div>
              </motion.div>
