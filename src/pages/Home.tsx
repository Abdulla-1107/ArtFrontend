          ...
          >
            ...
            >
              <Link to="/gallery">
                <Button
                  size="lg"
                  className="gap-2 text-lg px-10 py-7 shadow-elegant rounded-full hover:shadow-2xl transition-all duration-500"
                >
                  {t("hero.cta")}
          ...
          >
            <Link to="/gallery">
              <Button
                variant="outline"
                size="lg"
                className="gap-2 rounded-full px-8 py-6 hover:shadow-elegant transition-all duration-500"
              >
                {t("featured.viewAll")}
